...
import 'package:taxi_app/screens/sign_up_car.dart';
import 'package:taxi_app/utils/shared_pref.dart';

import '../utils/always_disable_focus_node.dart';
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Align(
                            ...
                            heightFactor: 1,
                            child: Image.asset('assets/images/driverIcon.png')),
                      ),
                    ),
                    SizedBox(
                      height: 15.0,
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      if (nameController.text != '' && genderText != '') {
                        ref.child('register_driver').push().set({
